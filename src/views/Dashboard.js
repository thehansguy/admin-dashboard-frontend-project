      ...
      <Container fluid>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Applicants</p>
                      <Card.Title as="h4">750,341</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Continuing Students</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Lecturers</p>
        ...
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Academic Calender</Card.Title>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                ...
                <p className="card-category">Last 3 Years</p>
              </Card.Header>
              <Card.Body>
                <div
                ...
                <div className="legend">
                  ...
                  2020 <i className="fas fa-circle text-warning"></i>
                  2021
                </div>
                <hr></hr>
                <div className="stats">
